...
async function syncdb() {
  ...
  let AstaConn = AstaConnectSock({
    ...
    browser: ["Windows", "chrome", "Queen Jessica"],
  ...
  AstaConn.ev.on("connection.update", async (_0x3fd0b3) => {
    ...
    if (_0x2224a7 === "open") {
      ...
      let _0x1f88ec = `🚀 QUEEN JESSICA 𝗖𝗢𝗡𝗡𝗘𝗖𝗧𝗘𝗗 ✅  
...
🔻 𝗣𝗢𝗪𝗘𝗥𝗘𝗗 𝗕𝗬 QUEEN JESSICA 🔻  

👉 𝗝𝗢𝗜𝗡 𝗖𝗛𝗔𝗡𝗡𝗘𝗟: https://whatsapp.com/channel/0029VabAgzO5Ejy5rD9exU2F ⚡`;
      ...
      global.qr_message = {
        message: "Queen Jessica ALREADY CONNECTED!",
        bot_user: _0x89b8f6,
    ...
    if (_0x2224a7 === "close") {
      ...
      global.qr_message = {
        message: "CONNECTION CLOSED WITH Queen Jessica!",
      };
...
<body>
  <div class="container">
    <h1 class="glitch">Queen Jessica</h1>
    <p>Welcome to the ultimate cyber world of Queen Jessica! Only the strongest survive.</p>
...
app.listen(randomPort, () =>
  console.log(
    "Queen Jessica Server listening on http://localhost:" + randomPort + "/ "
  )
);
